...
def plot_tradeoff_grounding_coherence(file_path):
    ...
    plt.savefig(output_dir / "fig_tradeoff_grounding_coherence.png", dpi=300)
    plt.savefig(output_dir / "fig_tradeoff_grounding_coherence.pdf")
    plt.savefig(output_dir / "fig_tradeoff_grounding_coherence.svg")
