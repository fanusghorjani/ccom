...
def plot_visibility_inequality(file_path):
    ...
    plt.savefig(output_dir / "fig_visibility_inequality.png", dpi=300)
    plt.savefig(output_dir / "fig_visibility_inequality.pdf")
    plt.savefig(output_dir / "fig_visibility_inequality.svg")
